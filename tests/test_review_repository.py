...
@pytest.mark.asyncio
async def test_create_review(sessionmaker, mocker):
...
@pytest.mark.asyncio
async def test_get_review_by_id(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
...
@pytest.mark.asyncio
async def test_get_pending_reviews(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
...
@pytest.mark.asyncio
async def test_update_review_status(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
...
@pytest.mark.asyncio
async def test_get_count_by_user_today(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
...
@pytest.mark.asyncio
async def test_delete_review_by_id(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
...
@pytest.mark.asyncio
async def test_get_archived_reviews(sessionmaker, mocker):
    from src.bot.repositories.review_repository import ReviewRepository
